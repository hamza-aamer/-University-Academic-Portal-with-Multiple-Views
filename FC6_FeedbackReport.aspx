...
<body>
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <div>
                <asp:Button ID="Button1" runat="server" Text="Show" CssClass="btn" BackColor="#009900" BorderColor="#003300" BorderStyle="Double" />
            </div>
            <div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField DataField="EVAL1_Perc" HeaderText="Evaluation 1" />
                        <asp:BoundField DataField="EVAL2_Perc" HeaderText="Evaluation 2" />
                        <asp:BoundField DataField="EVAL3_Perc" HeaderText="Evaluation 3" />
                        <asp:BoundField DataField="EVAL4_Perc" HeaderText="Evaluation 4" />
                        <asp:BoundField DataField="EVAL5_Perc" HeaderText="Evaluation 5" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
